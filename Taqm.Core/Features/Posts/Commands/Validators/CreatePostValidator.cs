...
namespace Taqm.Core.Features.Posts.Commands.Validators
{
    public class CreatePostValidator : AbstractValidator<CreatePostCommand>
    {
        ...
        #region Constructors
        public CreatePostValidator(IStringLocalizer<SharedResources> stringLocalizer)
        {
        ...
        public void ApplyValidationRules()
        {
            ...
            RuleFor(p => p.ProductDescription)
                .NotEmpty().WithMessage(_stringLocalizer[SharedResourcesKeys.NotEmpty])
                .NotNull().WithMessage(_stringLocalizer[SharedResourcesKeys.NotNull])
                .MaximumLength(50).WithMessage(_stringLocalizer[SharedResourcesKeys.MaxLength100]);
